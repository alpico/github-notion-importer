...
export const boardColumnPropName =
  process.env.BOARD_COLUMN_PROP_NAME ?? 'Status'
export const boardColumnDefaultVal =
...
export const ghNotionUserMap = JSON.parse(
  process.env.GITHUB_NOTION_USER_MAP ?? ''
)
